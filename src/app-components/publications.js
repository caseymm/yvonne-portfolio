    ...
    return (
      <div className="works">
        ...
        <div className="row">
          ...
          <p>Eadon, Yvonne M. “<a href="https://doi.org/10.5771/0943-7444-2020-6-441">(Not) Part of the System: Resolving Epistemic Disconnect Through Archival Reference.</a>” KNOWLEDGE ORGANIZATION 47, no. 6 (2020): 441–60.</p>
